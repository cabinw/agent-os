...
```text
bootstrap-admin.sh --upgrade-generation hub-admin-25-20260825-g1 [--rollback]
```
...
- old 25-file administrator tree `444a9550…`;
- new 25-file administrator tree `f9063464…`;
...
An absent predecessor is permitted for a host cold-installed at `444a9550…`.
