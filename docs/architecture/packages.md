...
| `memory-core` | `parseKnowledgeDraft`, `classifyKnowledgeEvent`, `buildKnowledgeWindow`, `createKnowledgeExtractor`; then `query`, `graph` | Knowledge candidates, causal windows, items and links |
