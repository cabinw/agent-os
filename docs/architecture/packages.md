...
| `memory-core` | knowledge/relation reducer, causal extraction, `createKnowledgeSuperseder`, `queryMemory`, `buildMemoryGraph` | Knowledge candidates, causal windows, immutable items, semantic relations, deterministic query and causedBy graph |
